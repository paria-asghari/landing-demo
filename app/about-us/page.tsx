...
export default function AboutUs() {
  ...
  return (
    <div className="pt-20 pl-64 min-h-screen bg-slate-900">
      <div className="max-w-2xl mx-auto py-24 px-6">
        <h1 className="text-3xl font-bold text-amber-500 mt-8 mb-8">{currentContent.title}</h1>
        <div className="text-blue-300 leading-relaxed space-y-6">
          {currentContent.paragraphs.map((text: string, i: number) => (
